...
Generally, a Security Label is assigned in accordance with a policy, which deems that some aspects of a valued information object warrant a level of confidentiality protection. The policy is _based on an assessment of the potential impact that a loss of confidentiality, integrity, or availability of such information or information system would have on organizational operations, organizational assets, or individuals_ (this definition of Security Category is used in a number of NIST publications, which are listed [here](http://fismapedia.org/index.php/Security_Category)).
